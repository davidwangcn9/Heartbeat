...
export const cycleTimeMapper = ({
  ...
  const cycleTimeValue: { [key: string]: ValueWithUnits[] } = {
    ...
    ANALYSIS_PROPORTION: calPerColumnTotalTimeDivTotalTime(METRICS_CONSTANTS.analysisValue),
    ...
    AVERAGE_ANALYSIS_TIME: getAverageTimeForPerColumn(METRICS_CONSTANTS.analysisValue),
