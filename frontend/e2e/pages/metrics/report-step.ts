...
export class ReportStep {
  ...
  async checkBoardMetricsReportReportDetail() {
    ...
    await expect(this.classificationRows.nth(14)).toContainText(this.combineStrings(['Sprint']));
    ...
    await expect(this.classificationRows.nth(28)).toContainText(this.combineStrings(['Labels']));
    await expect(this.classificationRows.nth(30)).toContainText(this.combineStrings(['Stream25', '5.56%']));
